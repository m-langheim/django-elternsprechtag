    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.IntegerField(choices=[(0, 'Elternteil'), (1, 'Lehrer'), (2, 'Anderes')], default=2, verbose_name='Rolle')),
        ...
        migrations.CreateModel(
            name='Student',
            fields=[
                ('shield_id', models.CharField(max_length=38, primary_key=True, serialize=False, unique=True)),
