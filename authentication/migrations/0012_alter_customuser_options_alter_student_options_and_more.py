...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('authentication', '0011_merge_20240109_1042'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operation', models.IntegerField(choices=[(0, 'no changes'), (1, 'Create new Student'), (2, 'Delete Student')], default=0)),
                ('student', models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, to='authentication.student', verbose_name='')),
            ],
        ),
    ]
